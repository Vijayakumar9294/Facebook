...
public class Stepdefinition_Cucum {
	...
	@When("All Login Details")
	public void all_login_details() throws AWTException, InterruptedException, IOException {
	...
	@Then("Enter The ScreenShot Details")
	public void enter_the_screen_shot_details() throws InterruptedException, IOException {
